...
public class AudioRecordThread implements Runnable {
    ...
    private void initAudio() {
        //The playback is the same as the recorded
        int sampleRate = 44100;

        //The same with the recoded
        int audioFormat = AudioFormat.ENCODING_PCM_16BIT;

        //Input mono for recording and output mono for playing
        ...
        // AcousticEchoCanceler Eliminates the role of signals captured from remote audio signals
        ...
        // AutomaticGainControl Automatic recovery of normal captured signal output
        ...
        // NoiseSuppressor Background noise of captured signal can be eliminated
